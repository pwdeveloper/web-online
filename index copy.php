    ...
    <div class="container theme-showcase" role="main">
        ...
        <div class="row test-area">
            <div class="col-lg-12">
                ...
                <form role="form" action="formhandler.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Email address</label> <input type="text" name="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputPassword1">Password</label> <input type="text" name="password" class="form-control" id="exampleInputPassword1" placeholder="Password">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="exampleInputFile">Security type:</label>
						<br>
                        <select name="orderby">
                            <option value="ssl">
                                SSL
                    ...
                    <div class="checkbox">
                        <label><input type="checkbox" name="checkbox[]" value="checkbox1">Check me out 1</label>
        ...
        <p><button type="button" class="btn btn-sm btn-default">Default</button> <button type="button" class="btn btn-sm btn-primary">Primary</button> <button type="button" class="btn btn-sm btn-success">Success</button> <button type="button" class="btn btn-sm btn-info">Info</button> <button type="button" class="btn btn-sm btn-warning">Warning</button> <button type="button" class="btn btn-sm btn-danger">Danger</button> <button type="button" class="btn btn-sm btn-link">Link</button></p>

        <p><button type="button" class="btn btn-xs btn-default">Default</button> <button type="button" class="btn btn-xs btn-primary">Primary</button> <button type="button" class="btn btn-xs btn-success">Success</button> <button type="button" class="btn btn-xs btn-info">Info</button> <button type="button" class="btn btn-xs btn-warning">Warning</button> <button type="button" class="btn btn-xs btn-danger">Danger</button> <button type="button" class="btn btn-xs btn-link">Link</button></p>
        ...
        <div class="dropdown theme-dropdown clearfix">
            <a id="dropdownMenu1" href="#" role="button" class="sr-only dropdown-toggle" data-toggle="dropdown">Dropdown</a>
        ...
        <div class="navbar navbar-default">
            <div class="container">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target=".navbar-collapse"><span class="sr-only">Toggle navigation</span></button> <a class="navbar-brand" href="#">Project name</a>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="list-group">
                    ...
                    <h4 class="list-group-item-heading"><a href="#" class="list-group-item active">List group item heading</a></h4>

                    <p class="list-group-item-text"><a href="#" class="list-group-item active">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</a></p><a href="#" class="list-group-item"></a>

                    <h4 class="list-group-item-heading"><a href="#" class="list-group-item">List group item heading</a></h4>

                    <p class="list-group-item-text"><a href="#" class="list-group-item">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</a></p><a href="#" class="list-group-item"></a>

                    <h4 class="list-group-item-heading"><a href="#" class="list-group-item">List group item heading</a></h4>

                    <p class="list-group-item-text"><a href="#" class="list-group-item">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</a></p>
                </div>
            </div><!-- /.col-sm-4 -->
        </div>
